...
export declare namespace PowerUp {
    interface IFrame {
        arg<T = any>(name: string): T;
        get<T = any>(scope: Scope | string, visibility: Visibility | string, key?: string, defaultValue?: T): Promise<T>;
    ...
    type Scope = 'board' | 'card' | 'member' | 'organization';
